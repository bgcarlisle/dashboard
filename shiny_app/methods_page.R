...
lim_opencode_tooltip <- strwrap("Depending on an author's contribution to a project, he/she/they may have differing influence on the decision whether to make data or code available alongside a publication.")
